...
public class TXTHandler extends AbstractHandler{
    @Override
    public void open(){
        System.out.println("TXT document has been opened!");
    }

    @Override
    public void create(){
        System.out.println("TXT document has been created!");
    }

    @Override
    public void change(){
        System.out.println("TXT document has been changed!");
    }

    @Override
    public void save(){
        System.out.println("TXT document has been saved!");
    }
}
